...
@section('content')
    ...
    <div class="content-header">
        <h4 class="title is-4">Tambah Kurikulum Baru</h4>
            ...
            <div class="card-content">
                ...
                <form action="{{ route('kurikulums.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="nama" class="input @error('nama') is-danger @enderror" placeholder="Contoh: Kurikulum Merdeka" value="{{ old('nama') }}" required>
                        </div>
                        @error('nama')
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <textarea class="textarea @error('keterangan') is-danger @enderror" name="keterangan" placeholder="Deskripsi singkat kurikulum">{{ old('keterangan') }}</textarea>
                        </div>
                         @error('keterangan')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
